...
$config['webmaster_email'] = 'iamgtskk@126.com';
...
|--------------------------------------------------------------------------
*/
$config['login-success'] = 'admin/data';
$config['logout-success'] = ''; // Set FALSE for landing page in /views/landing/, '' for home, or 'controller' for your custom controller
